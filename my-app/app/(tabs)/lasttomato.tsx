    ...
    <View style={styles.container}>
      <ScrollView>
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>Tomatto</Text>
          <TouchableOpacity>
        ...
        <View style={styles.card}>
          <View style={styles.titleRow}>
            <Text style={styles.productTitle}>Tomatto</Text>
            <View style={styles.rating}>
              <Text style={styles.ratingText}>4.5</Text>
              <AntDesign name="star" size={14} color="black" />
            </View>
          </View>
          <Text style={styles.oldPrice}>500g</Text>
        ...
        <View style={styles.description}>
          ...
          <Text style={styles.text}>
            The big tomatto is a staple ingredient, known for its sweet and savory flavour. Its large size and firm texture make it perfect for slicing, chopping, or caramelizing. The tomatto adds depth to soups, stews, salads, and more. Papery skin is typically golden or yellow, while the flesh is white or translucent.
          </Text>
        </View>
